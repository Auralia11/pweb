				...
				<tbody>
                    <?php foreach ($mahasiswa as $key => $value): ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-warning btn-sm" href="<?php echo base_url('mahasiswa/ubah/'.$value['mahasiswa_id']) ?>">Edit</a>
								<a class="btn btn-danger btn-sm btn-hapus" href="<?php echo base_url('mahasiswa/hapus/'.$value['mahasiswa_id']) ?>">Hapus</a>
                            </td>
                        </tr>
                    <?php endforeach ?>
				</tbody>
